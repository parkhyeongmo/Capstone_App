...
class SignupActivity : AppCompatActivity() {
    ...
    private fun signUp(KakaoToken: String, userInfo: HashMap<String, Any>) {
        RetrofitClass.api.signUp(KakaoToken, userInfo)!!.enqueue(object : retrofit2.Callback<loginResponse> {
            override fun onResponse(call: Call<loginResponse>, response: Response<loginResponse>) {
                if(response.isSuccessful) {
                    ...
                    if (UserInfo.type == 0) {
                        ...
                        val expertIntent = Intent(this@SignupActivity, ExpertActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var getData: String? = intent.getStringExtra("accessToken")
